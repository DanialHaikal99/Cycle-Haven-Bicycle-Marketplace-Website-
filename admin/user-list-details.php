...
<?php include_once("header.php");?>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">User Details Page</h3>
					<ol class="breadcrumb">
		...
		$code = $_REQUEST['code'];
		$result = mysqli_query($conn, "select * from HavenUser INNER JOIN HavenAccount ON HavenUser.UserUsername=HavenAccount.AccountUsername WHERE HavenAccount.AccountUsername = '$code'");
		...
		?>
                              ...
                              <tr>
                                  ...
                                  <td style="margin-left:20px;width:700px;color:black;">
                                      ...
                                      Username : <?php echo $row['UserUsername']; ?><br/><br/>
                                      User Name : RM <?php echo $row['UserName']; ?><br/><br/>
                                      User Email : <?php echo $row['UserEmail']; ?> <br/><br/>
                                      User Phone : <?php echo $row['UserPhone']; ?>
                                      <br/><br/>
                                      User Address : <?php echo $row['UserAddress']; ?>
                                      <br/><br/>
                                  </td>
                                  ...
                                  <td> <div class="btn-group">
                                      ...
                                      <button name="submit2" type="submit2" class="btn btn-danger"><i class="icon_close_alt2"></i> Disable User</button><br/>
                                           <small><span style="color:red;">Warning!</span> Disabling User Will Prevent User<br/> From Logging Into The Website. (Disabling <br/>Without A Reason Is Absolutely Unacceptable.)</small>
                                      </form>
                                  </div></td>
                              </tr>
