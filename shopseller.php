...
<head>
    ...
    <title>Bicycle Menu Seller | Cycle Haven</title>
...
<body>
	...
	<section>
		<div class="container">
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
                        <h2>Welcome <?php echo $_SESSION['AccountUsername'] ?></h2>
                         <a href="add-advertisement.php" type="button" class="btn btn-default get" style="margin-top:10px; margin-left:55px;font-size: 15px;">Add Advertisement</a>
                       <div class="price-range"><!--price-range-->
							...
							<div class="well">
                                ...
                                <form action="shopseller.php"  method="GET"> 
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<form action="shopseller.php" style="color:black;" method="POST">    
            ...
            <input type="submit" value="Sort" name="Submit" style="margin-left:100px;">
                            </form>
		...
		?>
						<div class="col-sm-4">
							...
							<div class="product-image-wrapper">
                                ...
                                ?></a></p>
                                        <?php
                                          ...
                                          $id = $row['BicycleID'];
                                         $result8 = mysqli_query( $conn, "SELECT AVG(ReviewStar) AS avg FROM HavenReview WHERE BicycleID='$id';");
                            ...
                            <p><i class="fa fa-comments" style="color:limegreen;"></i> (<?php  echo($row12['number']);?>) Review(s)</p>
                                       ...
                                       ?>
                                         <p>Rating: <?php  echo number_format($row8['avg'],1);?> <i class="fa fa-star" style="color:orange;"></i></p>
