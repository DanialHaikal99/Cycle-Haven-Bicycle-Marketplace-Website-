...
<head>
    ...
    <title>Bicycle Menu Admin  | Cycle Haven</title>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<form action="shopadmin.php" style="color:black;" method="POST">    
						...
						<div class="col-sm-4">
										...
										<p><b><?php echo $row['BicycleName']; ?></b></p>
                                         ...
                                         $result8 = mysqli_query( $conn, "SELECT AVG(ReviewStar) AS avg FROM HavenReview WHERE BicycleID='$id';");
                                          $row8 = mysqli_fetch_assoc($result8);
                                           ...
                                           if($row8['avg']==0){
                                               echo "<p style='color:orange;'>No Reviews Yet.</p> ";
                                           }
                                           else{
                                               ?>
                            ...
                            <p><i class="fa fa-comments" style="color:limegreen;"></i> (<?php  echo($row12['number']);?>) Review(s)</p>
                                       ...
                                       ?>
                                        ...
                                        <p style="font-size:12px;">Posted By <a href="vsellerprofilea.php?code=<?php echo $row['SellerUsername']; ?>" style="color:#00BFFF"><?php echo $row['AccountUsername']; ?><?php 
                                ...
                                ?></a></p>
                                        <a href="product-details-admin.php?code=<?php echo $row['BicycleID'];?>&code2=<?php echo $row['AccountUsername'];?>" class="btn btn-default add-to-cart"><i class="fa fa-mouse-pointer"></i>View Details</a>
                                        <?php 
