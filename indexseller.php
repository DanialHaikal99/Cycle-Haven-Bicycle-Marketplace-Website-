...
<head>
    ...
    <title>Seller Home | Cycle Haven</title>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
                                <li><a href="indexseller.php" class="active"><i class="fa fa-home"></i> Home</a></li>
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<p>Want to be verified in the system? Here's how.</p>
									<a href="verification-request.php" type="button" class="btn btn-default get">Learn More</a>
								</div>
								<div class="col-sm-6">
									<img src="images/home/seller1.png" class="girl img-responsive" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
									...
									<a href="shopseller.php" type="button" class="btn btn-default get">Get it now</a>
								</div>
								<div class="col-sm-6">
				...
				<div class="col-sm-9 padding-right">
					...
					<div class="features_items" style="border:1px solid black;"><!--features_items-->
						<h2 class="title text-center">Recently Added</h2>
		                 ...
		                 ?>
						<div class="col-sm-4">
							<div class="product-image-wrapper" style="max-height:310px;">
                            ...
                            <p><i class="fa fa-comments" style="color:limegreen;"></i> (<?php  echo($row12['number']);?>) Review(s)</p>
                                        <p style="font-size:12px;">Posted By <a href="vsellerprofiles.php?code=<?php echo $row['SellerUsername']; ?>" style="color:#00BFFF"><?php echo $row['AccountUsername']; ?><?php 
                                ...
                                ?></a></p>
										<a href="product-details-seller.php?code=<?php echo $row['BicycleID'];?>&code2=<?php echo $row['AccountUsername'];?>" class="btn btn-default add-to-cart"><i class="fa fa-mouse-pointer"></i>View Bicycle</a>
									</div>
								</div>
                                <!-- 
								<div class="choose">
