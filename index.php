					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li ><a href="shop.php"><i class="fa fa-shopping-cart"></i> Shop<i></i></a></li>
							</ul>
						</div>
					</div>
                    <!-- 
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<p>We are the marketplace for buyers and sellers alike. </p>
								</div>
								<div class="col-sm-6">
									<img src="images/home/bike1.png" class="girl img-responsive" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
									...
									<a href="shop.php" type="button" class="btn btn-default get">Get it now</a>
								</div>
								<div class="col-sm-6">
					...
					<div class="features_items" style="border:1px solid black;"><!--features_items-->
						...
						<div class="col-sm-4">
                            ...
                            <p><i class="fa fa-comments" style="color:limegreen;"></i> (<?php  echo($row12['number']);?>) Review(s)</p>
                                ...
                                ?></p>
										<a href="product-details.php?code=<?php echo $row['BicycleID'];?>&code2=<?php echo $row['AccountUsername'];?>" class="btn btn-default add-to-cart"><i class="fa fa-mouse-pointer"></i>View Bicycle</a>
									</div>
								</div>
                                <!-- 
								<div class="choose">
