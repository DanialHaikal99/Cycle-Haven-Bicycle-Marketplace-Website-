			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
                    <div class="mainmenu pull-left" style="margin-bottom:10px;">
                        <a class="btn btn-default" href="editsellerprofile.php" style="background-color:#2196F3;color:white;text-decoration:none;"><i class="fa fa-arrow-left" style="font-size:15px;margin-right:4px;"></i>Go Back</a>
						</div>
					...
					$inuser = mysqli_query($conn,$queryu);
						...
						<div class="col-sm-5" style="width:1100px;">
							<div class="view-product">
                                ...
                                <form action="editsellerpassword.php" method="post" name="editpassword">
