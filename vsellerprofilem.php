...
<div class="row" >
     <div class="mainmenu pull-left" style="margin-bottom:10px;margin-left:15px;">
							<a class="btn btn-default"  href="shop.php" style="color:white;text-decoration:none;background-color:#2196F3;"><i class="fa fa-shopping-cart"></i> Go To Shop</a>
						</div><br/><br/><br/>
                              ...
                              <div class="panel-body">
                                ...
                                ?></h4>
                                     <?php
                                       ...
                                       ?>
                                         <p>Seller Rating: <?php  echo number_format($row9['avg'],1);?> <i class="fa fa-star" style="color:orange;"></i></p><br/>
                                </div>
                              </div>
                            </div>
        </div>
              ...
              <div class="product-image-wrapper" style="border:1px solid silver;">
								...
								<div class="single-products">
									...
									<div class="productinfo text-center" >
                                        ...
                                        <p style="font-size:12px;">Posted By <a href="vsellerprofilem.php?code=<?php echo $row3['SellerUsername']; ?>" style="color:#00BFFF"><?php echo $row3['AccountUsername']; ?></a><?php 
                                ...
                                ?></p>
										<a href="product-details.php?code=<?php echo $row3['BicycleID'];?>&code2=<?php echo $row3['AccountUsername'];?>" class="btn btn-default add-to-cart"><i class="fa fa-mouse-pointer"></i>View Details</a>
