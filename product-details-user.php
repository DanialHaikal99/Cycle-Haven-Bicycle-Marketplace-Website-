			...
			<div class="row">
				<div class="col-sm-9 padding-right">
                     <div class="mainmenu pull-left" style="margin-bottom:10px;margin-left:15px;">
							<a class="btn btn-default" href="shopuser.php" style="color:white;text-decoration:none;background-color:#2196F3;"><i class="fa fa-arrow-left" style="font-size:15px;margin-right:4px;"></i> Go Back To Shop</a>
						</div><br/><br/>
					<div class="product-details" style="width:1100px;"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information" style="margin-left:30px;width:600px;"><!--/product-information-->
								...
								<p>Posted by <a href="vsellerprofileu.php?code=<?php echo $row['AccountUsername'];?>"><?php echo $row['AccountUsername']; ?></a><?php 
								...
								<span>
									...
									<button style="visibility:hidden;" type="button" class="btn btn-fefault cart" onclick="myFunction()">
										<i class="fa fa-shopping-cart"></i>
										Add to cart
									</button>
                                    <button  style="visibility:hidden;" type="hidden" class="btn btn-fefault cart" onclick="myFunction()">
                                    ...
                                    <form method='POST' action='cart.php?action=addCart&BicycleID=<?php echo $row["BicycleID"]; ?>'>
                                            ...
                                            <button name='addCart' class="btn btn-default add-to-cart" style="margin-top:5px;margin-right:70px;"><i class="fa fa-shopping-cart"></i>Add To Cart</button>
                                        ...
                                        <input type='hidden' name='hidden_bank' value="<?php echo $row["SellerBank"];?>">   
                                                <p style="color:black;float:left;margin-left:10px;margin-top:5px;">Quantity: <input type='number' name='gadget_quantity' value='0' style="width:50px;color:black;margin-right:10px;" min="1" max="5"></p>
                                        
                                    
                                    
                                   <h5>Pick The Bicycle Color</h5>
                                     <?php
                                ...
                                <a  class="btn btn-default add-to-cart" href="vsellerprofileu.php?code=<?php echo $row['AccountUsername'];?>" style="color:black;">Seller Profile</a>
					...
					<div class="category-tab shop-details-tab" style="border:1px dashed black;width:1085px;"><!--category-tab-->
						<div class="col-sm-12">
                            ...
                            <a  class="btn btn-default add-to-cart" href="product-user-allreviews.php?code=<?php echo $row['BicycleID'];?>&code2=<?php echo $row['AccountUsername'];?>" style="color:black;margin-left:22px;"><i class="fa fa-comments"></i>All Reviews</a>
